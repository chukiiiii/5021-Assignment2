        ...
        <div class="grid">
          <label>X Player
            <select id="xSpec">
              ...
              <option value="ppo:results/checkpoints/bc_mixed_large.pt">bc_mixed_large (SFT)</option>
              <option value="ppo:results/checkpoints/sft_ppo_conservative_seed901.pt">sft_ppo_conservative_seed901</option>
              <option value="ppo:results/checkpoints/sft_ppo_conservative_seed902.pt">sft_ppo_conservative_seed902</option>
              <option value="ppo:results/checkpoints/sft_ppo_conservative_seed903.pt">sft_ppo_conservative_seed903</option>
              <option value="ppo:results/checkpoints/ppo_long_seed501.pt">ppo_long_seed501</option>
              <option value="dqn:results/checkpoints/dqn_long_seed201.pt">dqn_long_seed201</option>
