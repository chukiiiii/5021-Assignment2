...
def main() -> None:
    ...
    parser.add_argument("--x", default="human", help="human | random | heuristic | mcts:N | qtable:path | dqn:path")
    parser.add_argument("--o", default="random", help="human | random | heuristic | mcts:N | qtable:path | dqn:path")
